            ...
            <div className="font-sans">
                <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                    <div className="max-w-2xl mx-auto text-center">
                        <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-center text-gray-900 dark:text-white">Rencontrez notre équipe</h2>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-4 md:grid-cols-3 gap-6 max-md:justify-center mt-12">
                        <div className="border rounded-lg overflow-hidden">
                            ...
                            <div className="p-4">
                                <h4 className="text-gray-800 text-base font-bold">Kieffer ILBOUDO</h4>
                        ...
                        <div className="border rounded-lg overflow-hidden">
                            ...
                            <div className="p-4">
                                <h4 className="text-gray-800 text-base font-bold">Idrissa OUEDRAOGO</h4>
                                <p className="text-gray-800 text-xs mt-1">Software Engineer</p>
                        ...
                        <div className="border rounded-lg overflow-hidden">
                            ...
                            <div className="p-4">
                                <h4 className="text-gray-800 text-base font-bold">Ina PARE</h4>
