                        ...
                        <div className="flex items-center justify-start">
                            ...
                            <a href="/" className="flex ml-2 md:mr-24">
                                <img src="https://flowbite-admin-dashboard.vercel.app/images/logo.svg" class="h-8 mr-3"
                                    alt="FlowBite Logo" />
                                <span
                                    className="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Rocket</span>
                            </a>
                            ...
                            <div className="flex items-center ml-3">
                                <div>
                                    <button type="button"
                                        ...
                                        <img className="w-8 h-8 rounded-full" src="{{ request.user.profile.avatar.url }}" alt="user photo" />
